...
Axios.interceptors.request.use(function(config) {
  ...
  if (config['Content-Type'] === 'application/x-www-form-urlencoded') { // 默认发application/json请求，如果application/x-www-form-urlencoded需要使用transformRequest对参数进行处理
    /* config['Content-Type'] = 'application/x-www-form-urlencodedcharset=UTF-8' */
